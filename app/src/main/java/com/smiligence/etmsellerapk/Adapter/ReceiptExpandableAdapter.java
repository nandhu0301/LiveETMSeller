...
public class ReceiptExpandableAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String, List<String >> finalBillList;
    ...
    public ReceiptExpandableAdapter(Context context, List<String> expandableListTitle,
                                    ...
                                    HashMap<String, List<String>> finalBillList,
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        paymentMode = this.paymentModeList.get(this.uniqueDateList.get(listPosition)).
                get(expandedListPosition);
        orderStatusText = this.orderStatusList.get(this.uniqueDateList.get(listPosition)).get(expandedListPosition);
    ...
    public int getChildrenCount(int listPosition) {
        return this.expandableListDetail.get(this.uniqueDateList.get(listPosition)).size();
    }
