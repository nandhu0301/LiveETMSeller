...
import static com.smiligence.etmsellerapk.SellerProfileActivity.storeName;
import static com.smiligence.etmsellerapk.SellerProfileActivity.storePincode;
...
import com.smiligence.etmsellerapk.SellerProfileActivity;
...
public class CommonMethods {
    ...
    public static DatabaseReference fetchFirebaseDatabaseReference(String FirebaseTableName) {
        ...
        DatabaseReference mDataRef = FirebaseDatabase.getInstance ("https://liveetmproject-default-rtdb.firebaseio.com/")
    ...
    public static StorageReference fetchFirebaseStorageReference(String FirebaseTableName) {
        ...
        StorageReference mStorageRef = FirebaseStorage.getInstance ("gs://liveetmproject.appspot.com")
                .getReference ( storeName + storePincode + FirebaseTableName );
        return mStorageRef;
    }
    ...
    public static void screenPermissions(){
        ...
        if ("Waiting for approval".equals ( statusChange ) || "".equals ( statusChange ) || "Rejected".equals ( statusChange )||
            ...
            MenuItem description =SellerProfileActivity.menuNav.findItem ( R.id.add_description );
